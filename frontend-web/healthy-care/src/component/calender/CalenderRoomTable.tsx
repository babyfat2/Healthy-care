                ...
                {data?.length === 0 ? (
                    ...
                    <>
                        ...
                        <div className="flex font-semibold text-gray-700 p-2 border-b border-gray-300 mb-2">
                            ...
                            <span className="w-1/4 text-center">Tên bác sĩ</span>
                            <span className="w-1/4 text-center">Email</span>
                        </div>
                        ...
                        <ul className="space-y-2">
                            {data?.map((shift) => (
                                ...
                                >
                                    ...
                                    <span className="w-1/4 text-center text-gray-600">{shift.full_name}</span>
                                    <span className="w-1/4 text-center text-gray-600">{shift.email || "N/A"}</span>
...
export default CalenderRoomTable;
