...
const Sidebar = ({ menuItems }: { menuItems: MenuItem[] }) => {
  ...
  return (
    <div className="w-64 h-screen bg-bgcharcoal-gray text-white flex flex-col p-4 gap-4">
      ...
      <button className="w-full flex items-center gap-3 p-3 rounded-lg bg-red-500 hover:bg-red-600 cursor-pointer">
